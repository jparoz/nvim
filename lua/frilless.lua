...
Group.new("Warning", colors.warning, colors.none, styles.italic)
...
Group.new("DiagnosticWarn", groups.WarningMsg, groups.WarningMsg, groups.WarningMsg)
Group.new("DiagnosticInfo", groups.WarningMsg, groups.WarningMsg, groups.WarningMsg)
Group.new("DiagnosticHint", groups.WarningMsg, groups.WarningMsg, groups.WarningMsg)

Group.new("DiagnosticVirtualTextError", groups.Virtual, groups.Virtual, groups.Virtual)
Group.new("DiagnosticVirtualTextWarn", groups.Virtual, groups.Virtual, groups.Virtual)
Group.new("DiagnosticVirtualTextInfo", groups.Virtual, groups.Virtual, groups.Virtual)
Group.new("DiagnosticVirtualTextHint", groups.Virtual, groups.Virtual, groups.Virtual)
