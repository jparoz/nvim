...
Group.new("DiagnosticWarning", groups.WarningMsg, groups.WarningMsg, groups.WarningMsg)
Group.new("DiagnosticInformation", groups.WarningMsg, groups.WarningMsg, groups.WarningMsg)
...
Group.new("DiagnosticVirtualTextWarning", groups.Virtual, groups.Virtual, groups.Virtual)
Group.new("DiagnosticVirtualTextInformation", groups.Virtual, groups.Virtual, groups.Virtual)
